========================================================================
    KONSOLENANWENDUNG: Visual Studio Console Test-Projektübersicht
========================================================================

Diese Visual Studio Console Test-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Visual Studio Console Test-Anwendung besteht.


Visual Studio Console Test.vcxproj
...
Visual Studio Console Test.vcxproj.filters
...
Visual Studio Console Test.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Visual Studio Console Test.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
